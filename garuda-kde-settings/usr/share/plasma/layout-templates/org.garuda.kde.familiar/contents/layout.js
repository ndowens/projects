...
if (Math.round(gridUnit / 18 * 38) >= 38) {
    panel.height = Math.round(gridUnit / 18 * 38);
} else {
    panel.height = 38;
}

var kickoff = panel.addWidget("org.kde.plasma.tiledmenu")
kickoff.currentConfigGroup = ["Shortcuts"]
kickoff.writeConfig("global", "Alt+F1")
kickoff.writeConfig("icon", "/usr/share/icons/garuda/garuda-white.png")
...
panel.addWidget("com.github.zren.presentwindows")
...
win7sd.writeConfig("click_action", "minimizeall")
